                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 justify-between">
                        ...
                        <div className="hidden sm:ms-6 sm:flex sm:items-center">
                            {/* Cart icon placed before profile dropdown */}
                            <div className="me-3 flex items-center">
                                <Link
                                    href={route('cart.index')}
                                    className="relative inline-flex items-center rounded-md border border-transparent bg-white px-3 py-2 text-sm font-medium text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 focus:outline-none"
                                >
                                    <ShoppingCart className="h-5 w-5" />
                                    {cartCount > 0 && (
                                        <span className="absolute -top-1 -end-0 inline-flex items-center justify-center rounded-full bg-red-600 px-1.5 py-0.5 text-xs font-semibold text-white">
                                            {cartCount}
                                        </span>
                                    )}
                                </Link>
                            ...
                            <div className="mt-3 space-y-1">
                                <ResponsiveNavLink href={route('cart.index')}>
                                    <span className="flex items-center gap-2">
                                        <span>Cart</span>
                                        {cartCount > 0 && (
                                            <span className="inline-flex items-center rounded-full bg-red-600 px-2 py-0.5 text-xs font-semibold text-white">{cartCount}</span>
                                        )}
                                    </span>
                                </ResponsiveNavLink>
